...
incumbency_table <- fb_ads |>
  group_by(incumbency) |>
  summarize(candidate_count = n_distinct(cand_name))
knitr::kable(incumbency_table)
```

There are 2509 challenger candidates, 2022 incumbent candidates, and 2448 open seat candidates. All together there are 6,979 candidates assigned in the data set.
